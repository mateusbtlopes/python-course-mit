# -*- coding: utf-8 -*-
"""
Created on Thu Jun 24 09:18:39 2021

@author: mateus.lopes

Unit 2 - Problem 3 - Using Bisection Search to Make the Program Faster
...
system might be limited to an error message complaining about toomuch time taken.)
...
reasonable lower bound for this payment value? $0 is the obvious answer,
...
interest was compounded on the balance we didn't pay off each month.
So a good upper bound for the monthly payment would be one-twelfth of
...
smallest monthly payment to the cent (no more multiples of $10) such that
we can pay off the debt within a year. Try it out with large inputs, 
